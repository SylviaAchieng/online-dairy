...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div id="id01" class="modal">
      <form class="modal-content animate" action="fetch.php" method="POST">
      <h3>  <b> <u> Add new farmer</u></b> </h3>
        <div class="container">
                <label for="id">Id Number <sup>*</sup> </label>
                <input type="text" name="id" value="" placeholder="id number" required/>
                <br>
                <label for="name">First Name <sup>*</sup> </label>
                <input type="text" name="fullname" value="" placeholder="enter name of farmer" required/>
                <br>
                <label for="ph">Phone number<sup>*</sup> </label>
                <input type="text" name="phone" value="" placeholder="Phone Number" maxlength="10" required/>
                <br>
    ...
    <?php
      ...
      <thead>
        <tr>
          ...
          <th scope="col"><i class="fas fa-user-alt"></i> Fullname</th>
